...
def get_params():
    params = {
        'weight': r"H:\total\liuyi\Y8\best.pt",
        'cfg': r"H:\total\liuyi\Y8\ultralytics\cfg\models\v8\Y87.yaml",
        # 'weight': r"H:\total\liuyi\Y8\best-base.pt",
        # 'cfg': r"H:\total\liuyi\Y8\ultralytics\cfg\models\v8\Y8_base.yaml",
        'device': 'cpu',
...
if __name__ == '__main__':
    ...
    model(r"H:\smoke\smoke823_2\JPEGImages\somke_smoking_995.jpg", 'result21')
